...
using notions developed more fully in :ref:`§1.3 <section 1.3>`. More systematic methods of calculation
are given in :ref:`§1.2 <section 1.2>`. These are sufficient to show for example that every group is realized 
